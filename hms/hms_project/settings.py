...
SECRET_KEY = 'django-insecure-hms-dev-secret-key-change-in-production'
...
# Serverless Email Service URL (running via serverless-offline)
EMAIL_SERVICE_URL = os.environ.get('EMAIL_SERVICE_URL', 'http://localhost:3000')
